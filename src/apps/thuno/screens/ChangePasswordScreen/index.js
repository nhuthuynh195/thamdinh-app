...
const eventChangepassSuccess = "CHANGE_PASS_SUCCESS";
...
class ChangePasswordScreen extends LayoutChangePassword {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      this.props.openAlert(`Đổi mật khẩu thành công`, eventChangepassSuccess);
    }
  }
  ...
  actionTypeAlert = () => {
    DeviceEventEmitter.addListener(eventChangepassSuccess, e => {
      this.props.navigation.goBack();
      this.props.actions.auth.resetStateChangePassword();
    });
  };
