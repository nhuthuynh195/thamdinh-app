...
class HotUpdate extends Component {
  ...
  render() {
    return (
      <Modal visible={this.state.showUpdate} transparent={true}>
                  ...
                  >
                    ...
                    >
                      <Text style={{ color: "#fff" }}>
                        Cài đặt bản cập nhật ngay bây giờ
                      </Text>
                    </View>
                  </TouchableOpacity>
                ) : this.state.isSync ? (
                  ...
                  >
                    {this.state.isMandatory ? null : (
                      ...
                      >
                        ...
                        >
                          <Text style={{ color: "#666" }}>Cập nhật sau</Text>
                        </View>
                      </TouchableOpacity>
                    )}
                    <TouchableOpacity
                      ...
                      >
                        <Text style={{ color: "#fff" }}>
                          {this.state.isMandatory
                            ? "Cập nhật ngay"
                            : "Tải về bản cập nhật ngay bây giờ"}
                        </Text>
                      </View>
                    </TouchableOpacity>
                  </View>
